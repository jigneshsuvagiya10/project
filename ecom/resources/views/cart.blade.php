...
<table id="cart" class="table table-hover table-condensed">
    ...
    <tfoot>
        ...
        <tr>
            <td colspan="5" class="text-right">
                <a href="{{ url('/showproduct') }}" class="btn btn-danger"> <i class="fa fa-arrow-left"></i> Continue Shopping</a>
                <a href="{{ url('/order') }}" class="btn btn-success"> <i class="fa fa-money"></i> Checkout</a>
                <!-- <button class="btn btn-success" onclick="event.preventDefault(); order();"><i class="fa fa-money"></i> Checkout</button> -->
            </td>
        </tr>
    </tfoot>
</table>
